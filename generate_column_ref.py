...
COLUMN_DESCRIPTIONS = {
    ...
    "entry.rcsb_entry_info.structure_determination_methodology": ("string", "Methodology used for structure determination"),

    # ── Experimental method & resolution ──
    "entry.exptl.method": ("string", "Experimental technique (X-RAY DIFFRACTION, SOLUTION NMR, ELECTRON MICROSCOPY, etc.)"),
    ...
    "entry.rcsb_entry_info.deposited_polymer_entity_instance_count": ("int", "Number of polymer chains in deposited structure"),
    "entry.rcsb_entry_info.deposited_nonpolymer_entity_instance_count": ("int", "Number of nonpolymer (ligand/solvent) instances"),
    ...
    # ── Polymer entity data ──
    "entry.polymer_entities.rcsb_polymer_entity_container_identifiers.entity_id": ("string", "Polymer entity ID within entry"),
    "entry.polymer_entities.rcsb_polymer_entity_container_identifiers.entry_id": ("string", "Entry ID for polymer entity"),
    "entry.polymer_entities.rcsb_polymer_entity_container_identifiers.uniprot_ids": ("list[string]", "UniProt IDs associated with polymer entity"),
    "entry.polymer_entities.entity_poly.pdbx_seq_one_letter_code": ("string", "Polymer entity sequence (one-letter code)"),
    ...
    "entry.polymer_entities.rcsb_entity_source_organism.taxonomy_lineage": ("list[string]", "Taxonomic lineage of source organism"),
    ...
    "entry.nonpolymer_entities.rcsb_nonpolymer_entity_container_identifiers.nonpolymer_comp_id": ("string", "Nonpolymer component (ligand) identiﬁer (PDB CCD code)"),
    "entry.nonpolymer_entities.rcsb_nonpolymer_entity_container_identifiers.entry_id": ("string", "Entry ID for nonpolymer entity"),
...
preset_map = {}  # path -> set of preset names
...
for preset_file in ["minimal.yaml", "standard.yaml"]:
    ...
    lines.append(f"| # | Column Name | Type | Description |\n")
    lines.append(f"|---|-------------|------|-------------|\n")
